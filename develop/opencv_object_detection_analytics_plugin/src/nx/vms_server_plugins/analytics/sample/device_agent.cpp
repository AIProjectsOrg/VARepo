...
//     "supportedTypes": [
//         {
//             "objectTypeId": ")json" + kCigaretteObjectType + R"json("
//         },
//         {
//             "objectTypeId": ")json" + kPersonObjectType + R"json("
//         },
//         {
//             "objectTypeId": ")json" + kSmokeObjectType + R"json("
//         }
//     ]
// }
// )json";
    ...
    return /*suppress newline*/ 1 + R"json(
{
    "typeLibrary": {
        ...
        "objectTypes": [
            {
                "id":   ")json" + kCigaretteObjectType + R"json(",
                "name": "Cigarette"
            },
            {
    ...
    int64_t timestampUs)
{
    ...
    for (const std::shared_ptr<Detection>& detection: detections)
    {
        ...
        if (detection->classLabel == "smoke")
            objectMetadata->setTypeId(kSmokeObjectType);
        else if (detection->classLabel == "person")
            objectMetadata->setTypeId(kPersonObjectType);
        else if (detection->classLabel == "cigarette")
            objectMetadata->setTypeId(kCigaretteObjectType);
...
//         // 2) Debug: report if we actually saw anything (but do NOT terminate)
//         // if (!detections.empty())
//         // {
//         //     pushPluginDiagnosticEvent(
//         //         IPluginDiagnosticEvent::Level::info,
//         //         "YOLOv8-Debug",
//         //         "Got non-empty detections (count = " +
//         //         std::to_string(detections.size()) +
//         //         ")"
//         //     );
//         // }

//         // 2) Debug: if we have ≥1 detections, push an informational diagnostic with the first box
//         //         if (!detections.empty())
//         //         {
//         //             const auto& first = detections[0];
//         //             const auto& box   = first->boundingBox;

//         //             std::string debugMsg =
//         //                 "First detection → label: " + first->classLabel +
//         //                 ", confidence: " + std::to_string(first->confidence) +
//         //                 ", bbox: [" +
//         //                     std::to_string(box.x) + "," +
//         //                     std::to_string(box.y) + "," +
...
//         //     {
//         //         if (det->classLabel == "cigarette" && det->confidence > 0.4f)
//         //         {
//         //             const auto& box = det->boundingBox;

//         //             std::string debugMsg =
//         //                 "Cigarette detected → label: " + det->classLabel +
//         //                 ", confidence: " + std::to_string(det->confidence) +
//         //                 ", bbox: [" +
//         //                     std::to_string(box.x) + "," +
//         //                     std::to_string(box.y) + "," +
//         //                     std::to_string(box.width) + "," +
...
//         //             pushPluginDiagnosticEvent(
//         //                 IPluginDiagnosticEvent::Level::info,
//         //                 "YOLOv8-CigaretteDetection",
//         //                 debugMsg
//         //             );

//         //             // stop after logging the first cigarette
//         //             break;
//         //         }
//         //     }
//         // }
